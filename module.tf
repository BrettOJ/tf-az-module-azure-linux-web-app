resource "azurerm_linux_web_app" "this" {
  ...
  dynamic "auto_heal_setting" {
    ...
    content {
      dynamic "action" {
        for_each = var.auto_heal_setting.action != null ? [var.auto_heal_setting.action] : []
        content {
      ...
      dynamic "trigger" {
        for_each = var.auto_heal_setting.trigger != null ? [var.auto_heal_setting.trigger] : []
        content {
          dynamic "requests" {
            for_each = var.auto_heal_setting.trigger.requests != null ? [var.auto_heal_setting.trigger.requests] : []
            content {
          ...
          dynamic "slow_request" {
            for_each = var.auto_heal_setting.trigger.slow_request != null ? [var.auto_heal_setting.trigger.slow_request] : []
            content {
          ...
          dynamic "slow_request_with_path" {
            for_each = var.auto_heal_setting.trigger.slow_request_with_path != null ? var.auto_heal_setting.trigger.slow_request_with_path : []
            content {
          ...
          dynamic "status_code" {
            for_each = var.auto_heal_setting.trigger.status_code != null ? var.auto_heal_setting.trigger.status_code : []
            content {
  ...
  dynamic "site_config" {
    ...
    content {
      ...
      dynamic "auto_heal_setting" {
        ...
        content {
          dynamic "action" {
            for_each = site_config.value.auto_heal_setting.action != null ? [site_config.value.auto_heal_setting.action] : []
            content {
              action_type = action.value.action_type
              minimum_process_execution_time = lookup(action.value, "minimum_process_execution_time", null)
            }
          ...
          dynamic "trigger" {
            for_each = site_config.value.auto_heal_setting.trigger != null ? [site_config.value.auto_heal_setting.trigger] : []
            content {
              dynamic "requests" {
                for_each = site_config.value.auto_heal_setting.trigger.requests != null ? [site_config.value.auto_heal_setting.trigger.requests] : []
                content {
                  count    = requests.value.count
                  interval = requests.value.interval
                }
              ...
              dynamic "slow_request" {
                for_each = site_config.value.auto_heal_setting.trigger.slow_request != null ? [site_config.value.auto_heal_setting.trigger.slow_request] : []
                content {
                  count     = slow_request.value.count
                  interval  = slow_request.value.interval
                  time_taken = slow_request.value.time_taken
              ...
              dynamic "slow_request_with_path" {
                for_each = site_config.value.auto_heal_setting.trigger.slow_request_with_path != null ? site_config.value.auto_heal_setting.trigger.slow_request_with_path : []
                content {
                  count     = slow_request_with_path.value.count
                  interval  = slow_request_with_path.value.interval
                  time_taken = slow_request_with_path.value.time_taken
              ...
              dynamic "status_code" {
                for_each = site_config.value.auto_heal_setting.trigger.status_code != null ? site_config.value.auto_heal_setting.trigger.status_code : []
                content {
                  count             = status_code.value.count
                  interval          = status_code.value.interval
                  status_code_range = status_code.value.status_code_range
  ...
  dynamic "logs" {
    ...
    content {
      dynamic "application_logs" {
        for_each = var.logs.application_logs != null ? [var.logs.application_logs] : []
        content {
      ...
      dynamic "http_logs" {
        for_each = var.logs.http_logs != null ? [var.logs.http_logs] : []
        content {
          dynamic "azure_blob_storage" {
